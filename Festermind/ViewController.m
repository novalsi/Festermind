...
-(NSString *)hurlInsult{
    ...
    NSMutableArray *twoRight = [[NSMutableArray alloc] initWithObjects:@"Halfway there ... I bet you hear that a lot.",
                                ...
                                @"You should find a grown up to help you with the rest.", nil];
    ...
    NSMutableArray *winnerText = [[NSMutableArray alloc] initWithObjects:@"Don't get so excited, it's just a game.",
                                ...
                                @"Millions of sperm, and you were the best swimmer.", nil];
    ...
    NSMutableArray *loserText = [[NSMutableArray alloc] initWithObjects:@"Let's see what a correct answer would look like.",
                                ...
                                @"You're just dumber'n a bag'a hammers.", nil];

    
    if (numCorrect == 0 && turnCount <10) {
        insult = arc4random() % [zeroRight count];
        angryText = [zeroRight objectAtIndex:insult];
    }
    else if (numCorrect == 1 && turnCount <10) {
        insult = arc4random() % [oneRight count];
        angryText = [oneRight objectAtIndex:insult];
    }
    else if (numCorrect == 2 && turnCount <10) {
        insult = arc4random() % [twoRight count];
        angryText = [twoRight objectAtIndex:insult];
    }
    else if (numCorrect == 3 && turnCount <10) {
        insult = arc4random() % [threeRight count];
        angryText = [threeRight objectAtIndex:insult];
    }
    else if (numCorrect == 4) {
        insult = arc4random() % [winnerText count];
        angryText = [winnerText objectAtIndex:insult];
    }
    else if (turnCount == 10 && numCorrect != 4) {
        insult = arc4random() % [loserText count];
        angryText = [loserText objectAtIndex:insult];
    }
